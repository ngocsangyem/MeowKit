...
2. **Follow gstack common protocols** — AskUserQuestion format, Completeness Principle, Repo Ownership, Search Before Building, Contributor Mode, Completion Status, Telemetry, Plan Status Footer. See `references/gstack-common.md`
...
10. **Run telemetry** — log session duration and outcome. See `references/gstack-common.md`

## References

- `references/preamble.md` — Preamble bash block, upgrade check, lake intro, telemetry prompt
- `references/gstack-common.md` — AskUserQuestion format, Completeness Principle, Repo Ownership, Search Before Building, Contributor Mode, Completion Status Protocol, Telemetry, Plan Status Footer
