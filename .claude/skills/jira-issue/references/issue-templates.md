...
These markdown templates are adopted from the upstream JIRA-Assistant-Skills (jira-issue/docs/templates/). Use one of these as the body of the `--description` flag when creating an issue via the wrapper:
