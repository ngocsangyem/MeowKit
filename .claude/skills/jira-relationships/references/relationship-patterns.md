...
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships get-blockers STORY-100 --recursive --depth 5
...
```bash
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships get-blockers PROJ-100 --recursive --output tree
...
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships bulk-link \
...
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships clone PROJ-100

# Preserve structure
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships clone PROJ-100 --include-links --include-subtasks

# Different project
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships clone PROJ-100 --to-project OTHER
```
...
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships get-dependencies PROJECT-ROOT --output mermaid

# Better - focused on current sprint
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships get-dependencies SPRINT-EPIC --output mermaid
```
...
bash $CLAUDE_PROJECT_DIR/.claude/skills/jira/scripts/jira-as.sh relationships get-dependencies RELEASE-EPIC --output dot > weekly-deps.dot
