...
> Part of meow:angular skill. Read when: working with routing.
> Source: analogjs/angular-skills/angular-routing (MIT)
...
- Authentication Flow (Complete auth setup with login, guards, session checking)
- Breadcrumbs
- Tab Navigation
- Modal Routes (Auxiliary outlets)
- Preloading Strategies (Built-in, Custom, Network-Aware)
- Route Animations
