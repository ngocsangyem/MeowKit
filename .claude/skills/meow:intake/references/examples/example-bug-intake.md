...
Walkthrough of meow:intake processing a real bug ticket end-to-end.
...
meow:scale-routing signals: "logged out", "auth", "session", "token"
...
### Step 7: Root cause analysis (meow:investigate)
...
**Handoff:** `meow:fix` (bug ticket, complexity: low)
