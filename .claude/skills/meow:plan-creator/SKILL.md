...
- User runs `/meow:plan archive` → route to `references/archive-workflow.md` (skip planning pipeline)
- User runs `/meow:plan red-team {path}` → route to `references/red-team-standalone.md` (skip planning pipeline)
- User runs `/meow:plan validate {path}` → route to `references/validate-standalone.md` (skip planning pipeline)
