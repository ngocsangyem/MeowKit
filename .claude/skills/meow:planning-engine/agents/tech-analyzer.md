...
description: >-
  ...
  feasibility. Internal agent of meow:planning-engine.
...
- Optional: prior meow:jira evaluate/estimate output (if in session or file)
...
`Read(".claude/skills/meow:planning-engine/references/tech-review-rubric.md")`
...
- Do NOT produce implementation plans (that's meow:plan-creator)
