...
Forks to the `confluence-page` agent (system prompt at `meowkit/.claude/agents/confluence-page.md`). The skill body is the task brief — Claude Code injects this content into the forked agent.
