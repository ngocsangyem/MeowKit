...
- **Outside Voice (optional):** Independent plan review via Claude adversarial subagent. Offered after all review sections complete in /meow:plan-ceo-review. Never gates shipping.
...
2. **If no override exists,** use AskUserQuestion:
   ...
   - Options: A) Ship anyway B) Abort — run /meow:review first C) Change is too small to need eng review
