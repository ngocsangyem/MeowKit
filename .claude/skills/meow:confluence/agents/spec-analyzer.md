...
description: >-
  ...
  Spec Research Report. Internal agent of meow:confluence.
...
`Read(".claude/skills/meow:confluence/references/spec-analysis-patterns.md")`
...
5. **Command suggestions** (only if `--with-commands` flag was passed):
   - Generate `/meow:jira create` commands wrapped in ===SUGGESTED_COMMANDS=== markers
