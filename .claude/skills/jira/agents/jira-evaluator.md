...
- Output: "Ticket has no text description — cannot evaluate. Ask reporter to add written description or run /mk:intake to process attached media."
...
- {actionable suggestions with /mk:jira commands}
