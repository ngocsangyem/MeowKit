...
> "No design doc found for this branch. `/mk:office-hours` produces a structured problem
> statement, premise challenge, and explored alternatives — it gives this review much
> sharper input to work with. Takes about 10 minutes. The design doc is per-feature,
> not per-product — it captures the thinking behind this specific change."

Options:
- A) Run /mk:office-hours now (we'll pick up the review right after)
- B) Skip — proceed with standard review

If they skip: "No worries — standard review. If you ever want sharper input, try
/mk:office-hours first next time." Then proceed normally. Do not re-offer later in the session.

If they choose A:

Say: "Running /mk:office-hours inline. Once the design doc is ready, I'll pick up
...
"Could not load /mk:office-hours — proceeding with standard review."
...
sure," or is clearly exploring rather than reviewing — offer `/mk:office-hours`:

> "It sounds like you're still figuring out what to build — that's totally fine, but
> that's what /mk:office-hours is designed for. Want to run /mk:office-hours right now?
> We'll pick up right where we left off."

Options: A) Yes, run /mk:office-hours now. B) No, keep going.
