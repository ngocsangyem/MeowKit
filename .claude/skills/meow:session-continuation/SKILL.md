...
Auto-prompt:
  "Token usage is at 75%. Would you like to save workflow state for continuation in a new session?"
```
...
**CONTINUING FROM:** Phase 3 - Build GREEN
...
Some recent progress may be lost.
