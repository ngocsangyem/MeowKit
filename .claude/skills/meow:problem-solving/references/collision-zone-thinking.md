...
**Where it breaks:** Circuits don't have retry logic or healing mechanisms.
**Insight:** Failure-isolation patterns from electrical engineering.
...
**Related:** Inversion Exercise (after forcing a metaphor, invert its assumptions) · First Principles (collide the fundamentals, not the surface patterns).
