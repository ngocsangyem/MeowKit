...
The detection runs silently. The banner output from `meow:agent-detector` shows complexity and model tier — budget level is an internal parameter, not a user-facing concept.
