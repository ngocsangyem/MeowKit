...
- **For complex changes (3+ files):** Run `/mk:scout` first to identify edge cases before review
- **After verdict:** Optionally run `/mk:elicit` for structured second-pass reasoning on findings
