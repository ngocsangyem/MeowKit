...
- `.meowkit/memory/architecture-decisions.json`: canonical past decisions relevant to this domain; use the generated `.md` view only when it improves readability
