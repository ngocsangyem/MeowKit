...
- **Implementation-phase variants:** `.claude/skills/cook/SKILL.md` and `.claude/skills/cook/references/failure-catalog.md` (TDD-specific entries live there).
- **Exploration-phase variants:** `.claude/skills/brainstorming/references/anti-rationalization.md` (decomposition / discovery / anti-bias-pivot rationalizations are domain-specific to brainstorming).
