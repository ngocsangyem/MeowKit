...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-neutral"
      }
    },
    {
      "color": "neutral" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-neutral/10 has-data-[state=checked]:border-neutral/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "neutral" as typeof color[number],
