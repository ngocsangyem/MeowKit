...
describe("isHostAllowed", () => {
	...
	const denied = [`evil.test:${PORT}`, `127.0.0.1:9999`, `localhost:9999`, "127.0.0.1.evil.test", `http://127.0.0.1:${PORT}`, ""];
...
describe("isOriginAllowed", () => {
	...
	const denied = [`https://127.0.0.1:${PORT}`, `http://evil.test:${PORT}`, `http://127.0.0.1:9999`, `http://127.0.0.1:${PORT}/path`, ""];
