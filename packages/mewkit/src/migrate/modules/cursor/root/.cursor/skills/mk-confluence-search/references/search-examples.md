...
**Wrapper invocation:**
```bash
bash $(git rev-parse --show-toplevel)/.cursor/skills/confluence/scripts/confluence-as.sh search \
...
```bash
bash $(git rev-parse --show-toplevel)/.cursor/skills/confluence/scripts/confluence-as.sh search export \
