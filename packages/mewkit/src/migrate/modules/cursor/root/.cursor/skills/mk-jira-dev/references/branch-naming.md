...
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh dev branch-name PROJ-123
# Output: feature/proj-123-fix-login-button

# Auto-detect prefix from issue type
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh dev branch-name PROJ-123 --auto-prefix

# Custom prefix
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh dev branch-name PROJ-123 --prefix hotfix

# Generate and checkout in one command
$(bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh dev branch-name PROJ-123 --output git)
```
