...
/**
 * mk:web-to-markdown tier-4 fallback for mk:docs-finder
 *
 ...
 * delegating to mk:web-to-markdown. This is a mandatory cross-skill trust-
...
function buildDelegationCommand(url) {
	...
	return (
		...
		`.cursor/skills/web-to-markdown/scripts/fetch_as_markdown.py ` +
