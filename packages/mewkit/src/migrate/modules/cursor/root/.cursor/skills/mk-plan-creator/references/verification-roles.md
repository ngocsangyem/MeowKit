...
Tier auto-selected from a count of files matching `phase-XX-*.md`. `verification_tier` is set by step-04 and read by step-06 to generate interview questions from FAILED claims.
