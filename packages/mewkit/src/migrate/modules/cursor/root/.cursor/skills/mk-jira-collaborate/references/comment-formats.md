...
```bash
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh collaborate comment add PROJ-123 --body "Simple plain text comment"
```
...
```bash
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh collaborate comment add PROJ-123 --format markdown --body "**Bold** and *italic*"
```
...
```bash
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh collaborate comment add PROJ-123 --format markdown --body "$(cat <<'EOF'
## Update
...
```bash
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh collaborate comment add PROJ-123 --format adf --body '{
  "version": 1,
  "type": "doc",
  "content": [
    {
...
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh \
