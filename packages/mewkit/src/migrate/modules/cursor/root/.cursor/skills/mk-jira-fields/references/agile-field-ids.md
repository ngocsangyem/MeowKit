...
```bash
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh fields list --agile
```
...
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh fields check-project PROJ --check-agile

# Search by partial name
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh fields list --filter "sprint"
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh fields list --filter "story"
bash $(git rev-parse --show-toplevel)/.cursor/skills/jira/scripts/jira-as.sh fields list --filter "epic"
```
