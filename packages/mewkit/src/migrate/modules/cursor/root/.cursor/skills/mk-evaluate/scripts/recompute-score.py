...
script recomputes the score from:
  - the preset's weights            (.cursor/rubrics/composition-presets/<preset>.md)
  - each rubric's hard_fail_threshold (.cursor/rubrics/<rubric>.md)
...
def main():
    ...
    ap.add_argument("--rubrics-dir", default=".cursor/rubrics")
    args = ap.parse_args()
