...
For each OWASP category, perform targeted analysis. Use the host runtime's code-search capability for all searches — scope file extensions to detected stacks from Phase 0.
