...
# Use search/file-glob to search within project:
#   Search: docs/ README.md for query keywords
#   File-glob: docs/**/*.md, *.spec.md, *.design.md
#   Read matched files
...
1. **Search the docs/ directory** for keywords from the query
2. **File-glob for spec/design files:** `docs/**/*auth*.md`, `docs/**/*api*.md`
