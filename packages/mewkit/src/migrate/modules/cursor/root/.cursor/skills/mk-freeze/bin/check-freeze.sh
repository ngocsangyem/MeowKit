#!/usr/bin/env bash
# check-freeze.sh — pre-write guard script for the mk-freeze skill,
...
# Locate the freeze directory state file — respect PLUGIN_DATA if set
FREEZE_FILE="${PLUGIN_DATA:-.meowkit/memory}/freeze-dir.txt"
