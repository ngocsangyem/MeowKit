...
**Always use the tracked delegation surface — not a fire-and-forget Agent call.** A trackable surface enables listing, updating, and checking tasks for progress and blocking; cook treats this capability as an interface, not a specific tool name.
