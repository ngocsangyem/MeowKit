...
Skip when:
- `MEOWKIT_AUTOBUILD_MODE=LEAN` (adaptive density bypass for the complex/capable tier)
...
```bash
.cursor/skills/sprint-contract/scripts/validate-contract.sh tasks/contracts/{path}.md
```
