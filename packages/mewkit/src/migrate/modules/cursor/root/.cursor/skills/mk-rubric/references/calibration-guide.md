...
**Practical sources:**
1. `tasks/reviews/*-verdict.md` from prior `the review skill` runs
...
When a new model tier is rolled out (a new standard-tier or capable-tier release, etc.), re-run a calibration pass:
