...
// `afterMCPExecution`, and `preCompact`. One script, six hooks.json entries —
// each entry's own `hook_event_name` in the payload tells this script which
// JSONL file to append to. `preCompact` is best-effort telemetry ONLY here;
