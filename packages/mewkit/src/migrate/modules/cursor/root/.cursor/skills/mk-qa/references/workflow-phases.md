...
# File-glob for file patterns matching the affected page
```
...
- Include full attribution comment:
  ...
  // Found by the qa skill on {YYYY-MM-DD}
...
2. **Fixed bugs that were in TODOS.md** → annotate with "Fixed by the qa skill on {branch}, {date}"