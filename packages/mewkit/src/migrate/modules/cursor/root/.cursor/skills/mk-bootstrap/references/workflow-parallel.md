...
Spawn max 2 researcher sub-task in parallel (≤150 lines each).
...
```
the plan-creator skill [requirements summary] --parallel
```
...
1. **Phase A:** Activate mk:cook skill: `the cook skill [plan-path] --parallel`
