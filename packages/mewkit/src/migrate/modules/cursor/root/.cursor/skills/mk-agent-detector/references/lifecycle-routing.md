...
| Runtime context decision — context near budget, long session degrading, choosing a minimal read-set, or compact vs clear vs sub-agent | Any | mk:context-engineering (routes to one of 25 context patterns per decision; NOT a structural kit-overhead audit — see mk:context-audit) |
