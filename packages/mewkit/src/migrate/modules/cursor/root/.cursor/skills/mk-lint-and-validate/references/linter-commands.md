...
| ------------------ | ------------------------- | ------------------------------------------------------------------- |
| `validate.py`      | General code validation   | `.cursor/skills/.venv/bin/python3 <path-to-validate.py>`          |
| `security-scan.py` | Security pattern scanning | `.cursor/skills/.venv/bin/python3 <path-to-security-scan.py>`     |
