...
**Daily mode (default, `the cso skill`):** 8/10 confidence gate. Zero noise. Only report what you're sure about.
...
2. Search the codebase for the same pattern across all relevant files
