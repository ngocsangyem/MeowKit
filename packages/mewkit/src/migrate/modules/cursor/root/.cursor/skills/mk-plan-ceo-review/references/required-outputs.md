...
Present each potential TODO as its own individual stop and ask the user in chat. Never batch TODOs — one per question. Never silently skip this step. Follow the format in `.cursor/skills/review/TODOS-format.md`.
