...
MEOWKIT_RUN_ID="$run_id" .agents/skills/autobuild/scripts/budget-tracker.sh add "$step_cost_usd" "step-04-iter-${iteration}"
MEOWKIT_RUN_ID="$run_id" .agents/skills/autobuild/scripts/budget-tracker.sh check
```
