...
See `.cursor/agents/*.md` for each agent's routing-trigger description. Skill dispatch (intent → skill) lives separately in `.agents/skills/agent-detector/references/skill-domain-routing.md`.
...
**Agent routing:** see `.cursor/agents/*.md` for the 3 agents' frontmatter-declared routing triggers. **Skill dispatch:** `.agents/skills/agent-detector/references/skill-domain-routing.md`.
