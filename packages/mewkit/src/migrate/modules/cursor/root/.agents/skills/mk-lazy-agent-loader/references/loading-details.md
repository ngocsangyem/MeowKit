...
```bash
# Load full agent definition from .cursor/agents/
cat .cursor/agents/developer.md
```
...
→ Re-read full definition from .cursor/agents/developer.md
```
...
2. Lazy Loader activates:
   - Load: .cursor/agents/developer.md (~1500 tokens)
