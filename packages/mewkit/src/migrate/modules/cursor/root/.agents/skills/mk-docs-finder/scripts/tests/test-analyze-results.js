...
assertEqual(
	categorizeUrl("https://api.example.com/migration"),
	"supplementary",
	"Hostname keywords do not affect priority",
);
assertEqual(
	categorizeUrl("https://docs.example.com/random-page?migration=1"),
	"important",
	"Query keywords do not affect priority",
);
assertEqual(
	categorizeUrl("https://docs.example.com/random-page#api"),
	"important",
	"Hash keywords do not affect priority",
);
