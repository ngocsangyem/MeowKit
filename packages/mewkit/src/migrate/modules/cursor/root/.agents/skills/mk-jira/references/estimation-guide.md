...
All user-derived terms: `bash .agents/skills/jira/scripts/jql-sanitize.sh '<term>'`
...
"Tip: run `the jira skill evaluate {ISSUE-KEY}` first for more informed estimation."
