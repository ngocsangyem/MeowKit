...
For post-build operational gotchas (parallel deadlocks, stale plans, model tier, memory), see cook `SKILL.md` `## Gotchas`. For implementation-phase generic rationalizations, see AGENTS.md (Core behaviors).
