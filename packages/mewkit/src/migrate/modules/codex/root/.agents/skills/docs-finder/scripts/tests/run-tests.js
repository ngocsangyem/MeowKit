...
/**
 * Test runner for mk:docs-finder scripts
 */

const { spawn } = require("child_process");
const path = require("path");

const tests = ["test-detect-source.js", "test-fetch-context7.js", "test-fetch-chub.js", "test-analyze-results.js"];
...
async function runAllTests() {
	console.log("Running all mk:docs-finder tests...");
