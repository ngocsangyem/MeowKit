...
assertEqual(buildContext7Url("vercel/next.js"), "https://context7.com/vercel/next.js/llms.txt", "GitHub repo URL");
...
assert(
	v3.some((v) => v.type === "official-llms-txt"),
	"Includes official llms.txt",
);
