---
name: "rule-agile-feedback-cycle"
description: "rule-agile-feedback-cycle"
---
...
2. ≥1 item → per-item stop and ask the user in chat. 0 items → freeform: "List action items, one per line. Empty = no action."
