...
Ask these questions **ONE AT A TIME** via stop and ask the user in chat. Push on each one until the answer is specific, evidence-based, and uncomfortable. Comfort means the founder hasn't gone deep enough.
