...
**Remediation Roadmap:** For the top 5 findings, present via stop and ask the user in chat:
...
**This tool is not a substitute for a professional security audit.** the cso skill is an AI-assisted
...
sensitive data, payments, or PII, engage a professional penetration testing firm. Use the cso skill as
...
**Always include this disclaimer at the end of every the cso skill report output.**