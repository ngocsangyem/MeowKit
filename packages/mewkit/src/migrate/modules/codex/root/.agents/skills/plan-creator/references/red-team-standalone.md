...
Subcommand: `the plan skill red-team {plan_path}`
...
Examples:
- `the plan skill red-team tasks/plans/260411-my-feature/`
- `the plan skill red-team tasks/plans/260411-my-feature/plan.md`
