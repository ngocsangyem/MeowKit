---
name: "rule-agent-conduct"
description: "rule-agent-conduct"
---
...
- If sub-task fails 3+ times on same task → escalate to user, don't retry blindly
...
- Scope file reads and searches narrowly; use sub-task for broad investigations.
