...
**Path convention:** All references use `.agents/skills/{domain}/references/{file}.md`
...
- `.agents/skills/development/references/code-patterns.md` (NestJS section)
- `.agents/skills/review/references/adversarial-review.md`
- `.agents/skills/testing/references/red-green-refactor.md`
- `.agents/skills/document-release/references/general-documentation.md`

### Rule 2: Vue Frontend
**Trigger:** Task touches `.vue` files, or `.ts` files in a Vue context (files importing from `vue`, `pinia`, `vue-router`).

**Load these references:**
- `.agents/skills/development/references/code-patterns.md` (Vue 3 section)
- `.agents/skills/testing/references/visual-qa.md`
- `.agents/skills/testing/references/red-green-refactor.md`
...
**Load these references:**
- `.agents/skills/development/references/code-patterns.md` (Swift section)
- `.agents/skills/testing/references/red-green-refactor.md`
...
**Load these references:**
- `.agents/skills/plan-creator/references/adr-generation.md` (schema changes deserve ADRs)

### Rule 5: Planning / Architecture
**Trigger:** Task is a planning request, design discussion, or architectural decision.

**Load these references:**
- `.agents/skills/plan-creator/references/scope-challenge.md`
- `.agents/skills/plan-creator/references/adr-generation.md`

### Rule 6: Shipping / Deployment
**Trigger:** Task involves deploying, creating PRs, releasing, or rolling back.

**Load these references:**
- `.agents/skills/ship/SKILL.md` — unified ship pipeline (merge base, tests, review, PR)

## Always-Loaded References

These are loaded for EVERY task regardless of domain:
- `.agents/skills/memory/references/session-capture.md` (captures learnings)
- `.agents/skills/development/references/tdd-enforcement.md` (enforces test-first)
