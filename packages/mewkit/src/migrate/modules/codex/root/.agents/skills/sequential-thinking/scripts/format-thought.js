...
if (require.main === module) {
	...
	switch (fmt) {
		case "simple":
			console.log(ThoughtFormatter.formatSimple(data));
			break;
		case "markdown":
			console.log(ThoughtFormatter.formatMarkdown(data));
			break;
		case "json":
			console.log(ThoughtFormatter.formatJson(data));
			break;
		default:
			console.log(ThoughtFormatter.format(data));
	}
}
