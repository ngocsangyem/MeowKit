...
For backward compatibility, `--red-only` still forces the RED-phase write-failing-tests behavior regardless of mode (used by `the cook skill` Phase 2 in TDD mode).
