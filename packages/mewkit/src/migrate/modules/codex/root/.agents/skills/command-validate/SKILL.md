...
LLM-based review (`the review skill`, `the audit skill`) is powerful but non-deterministic. `the validate skill` provides a complementary layer of checks that are:
