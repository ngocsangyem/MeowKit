...
The files at `.agents/skills/jira-lifecycle/references/patterns/` (`standard-workflow.md`, `software-dev-workflow.md`, `jsm-request-workflow.md`, `incident-workflow.md`) describe **common workflow shapes** for orientation. They are NOT your project's actual workflow.
