---
name: "rule-security-rules"
description: "rule-security-rules"
---
...
If the agent detects these patterns in existing code during `the review skill` or `the audit skill`:
