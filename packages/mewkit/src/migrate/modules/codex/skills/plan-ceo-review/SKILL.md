...
5. **Deep Review (Layer 4)** — sections 1-11 (Architecture → Design/UX) with **severity tiers** (BLOCKER/HIGH-LEVERAGE/POLISH) and **adversarial necessity** (must surface ≥1 finding per section or document evidence why clean). Optional outside voice from sub-task. See `references/review-sections.md`, `references/outside-voice.md`
...
<!-- GATE 1 HARD STOP — CEO Review
     Human decides: run the cook skill to implement,
     or run mk:review for engineering review.
