...
```bash
# List all rubrics
.agents/skills/rubric/scripts/load-rubric.sh --list
...
.agents/skills/rubric/scripts/load-rubric.sh --preset frontend-app

# Validate every rubric file in the library
.agents/skills/rubric/scripts/validate-rubric.sh
```
