...
4. `.meowkit/memory/architecture-decisions.json` — recurring architectural patterns (canonical; fall back to `architecture-decisions.md` only if absent — see `.claude/rules/memory-read-rules.md`)
