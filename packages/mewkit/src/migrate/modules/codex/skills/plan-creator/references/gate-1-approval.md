...
Print a summary, then use `stop and ask the user in chat` for structured approval:
...
**ACTION REQUIRED:** Use `stop and ask the user in chat`. Header: "Gate 1". Question: "Plan is ready. How would you like to proceed?" Single-select.
...
|-----------|-------------|
| (default) / --hard | `the cook skill {absolute-path}/plan.md` |
| --auto | `the cook skill --auto {absolute-path}/plan.md` |
| --fast | `the cook skill --auto {absolute-path}/plan.md` |
| --parallel | `the cook skill --parallel {absolute-path}/plan.md` |
| --deep | `the cook skill {absolute-path}/plan.md` |
...
│                                                         │
│      the cook skill [flag] [absolute path to plan.md]       │
│                                                         │
