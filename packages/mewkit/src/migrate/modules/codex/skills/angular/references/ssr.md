...
> Part of mk:angular skill. Read when: working with ssr.
...
- SEO Optimization (Meta Tags Service, Route-Based SEO with Resolvers)
- Authentication with SSR (Cookie-Based Auth, Skip SSR for Authenticated Routes)
- Caching Strategies (HTTP Cache Headers, CDN Caching, Stale-While-Revalidate)
- Error Handling (SSR Error Boundaries, Graceful Degradation)
- Performance Optimization (Lazy Hydration Strategy, Preload Critical Data, Streaming SSR)
