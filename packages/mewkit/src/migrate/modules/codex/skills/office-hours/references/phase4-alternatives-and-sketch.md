...
- If the second-opinion sub-task proposed a prototype in Phase 3.5, consider using it as a starting point for the creative/lateral approach.

**RECOMMENDATION:** Choose [X] because [one-line reason].

Present via stop and ask the user in chat. Do NOT proceed without user approval of the approach.
...
If user chooses A, dispatch two parallel sub-task via the Agent tool:

1. **Visual thesis sub-task:**
...
2. **Design direction sub-task:**
"For this product approach, what design direction would you recommend? What aesthetic, typography, and interaction patterns fit? What would make this approach feel inevitable to the user? Be specific — font names, hex colors, spacing values."

Present outputs under `VISUAL THESIS (sub-task):` and `DESIGN DIRECTION (sub-task):` headers.

**Error handling:** All non-blocking. On sub-task failure, skip that voice and continue with whatever succeeded.