...
Story-sizer NEVER auto-invokes `the scout skill`. This preserves the trust boundary documented in `mk:planning-engine/SKILL.md` and avoids skill-to-skill invocation forbidden by `.claude/rules/skill-authoring-rules.md`.
