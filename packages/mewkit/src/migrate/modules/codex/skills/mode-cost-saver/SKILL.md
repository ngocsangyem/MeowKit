---
name: "mode-cost-saver"
description: "mode-cost-saver"
---
...
Lower cost comes at the expense of reduced review depth. Use for low-risk work only. Monitor `.meowkit/memory/cost-log.json` to track savings.