...
const ProviderPathMigrationEntrySchema = z
	.object({
...
const SectionRenameEntrySchema = z
	.object({
...
const PortableEvolutionManifestSchema = z
	.object({
...
export const MANAGED_MIGRATION_REPORT_BASENAMES: readonly string[] = ["migration-report.json", "migration-report.md"];
