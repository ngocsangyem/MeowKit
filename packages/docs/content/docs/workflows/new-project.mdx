...
**What gets created:** A `.claude/` directory with 40 agents, 126 skills, lifecycle hooks, security rules, and a memory system. Plus `CLAUDE.md` (the entry point Claude reads at session start).
