...
**What gets created:** A `.claude/` directory holding the agents, skills, lifecycle hooks, security rules, and memory system. Plus `CLAUDE.md` (the entry point Claude reads at session start).
