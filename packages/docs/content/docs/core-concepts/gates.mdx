...
sourceOfTruth: ".claude/rules/gate-rules.md"
...
3. **Test coverage.** Edge cases covered, testing behavior rather than implementation
4. **Security.** Passes the `security-rules.md` checklist
