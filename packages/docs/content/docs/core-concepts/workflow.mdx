...
sourceOfTruth: ".claude/rules/phase-contracts.md"
...
| **Stage** | A step *inside* a phase. Simplify and Verify sit inside Build. No gate, no approval. |
...
**Agent:** tester
**Produces:** tests, failing ones in TDD mode and optional otherwise
