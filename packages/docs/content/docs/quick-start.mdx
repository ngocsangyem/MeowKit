...
The CLI walks you through a short set of prompts — every one after the toolkit picker is skippable. See [Installation](/installation) for the full list and the flags that skip them. Takes ~30 seconds.
