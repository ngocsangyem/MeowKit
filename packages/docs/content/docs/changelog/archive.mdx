...
description: "Every MeowKit release before the current line, kept in full."
---

Releases before the current line, in full. The [current changelog](/changelog) covers everything since.
