...
## 2.15.0 (2026-07-27) — Opt-In Strategic Supervision

Ships as kit **2.15.0** and **`mewkit` CLI 2.3.0** (minor — the CLI gains a new command surface). A new advisory agent can supervise a single delivery run when you ask for it, and it holds no authority over any gate.
