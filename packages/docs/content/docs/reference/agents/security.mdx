...
| | |
|---|---|
| **Source** | [`.claude/agents/security.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/security.md) |
| **Owner** | `security` |
| **Runtime** | `claude-code` |
| **Risk** | critical |
| **Writes** | `.claude/rules/security-rules.md`, `tasks/reviews/*-security-verdict.md` |
