...
| | |
|---|---|
| **Source** | [`.claude/agents/story-sizer.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/story-sizer.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `.claude/rules-conditional/agile-story-gates.md`, `.claude/rules/agent-conduct.md`, `.claude/rules/injection-rules.md`, `.claude/skills/story-sizer/assets/sizing-report-template.md`, `.claude/skills/story-sizer/references/auto-create-execution.md`, `.claude/skills/story-sizer/references/auto-create-gating.md`, `.claude/skills/story-sizer/references/input-adapter.md`, `.claude/skills/story-sizer/references/report-writer.md`, `.claude/skills/story-sizer/references/sizing-heuristics.md`, `/mk:scout`, `docs/project-context.md`, `tasks/reports/story-sizing-*.md`, `tasks/reports/story-sizing-&#123;YYMMDD&#125;-&#123;slug&#125;.md` |
...
- Workflow: [Spec → PR walkthrough, Step 3.5](/workflows/spec-to-pr-walkthrough/step-03-5-story-sizing)
