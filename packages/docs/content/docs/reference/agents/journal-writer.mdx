...
| | |
|---|---|
| **Source** | [`.claude/agents/journal-writer.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/journal-writer.md) |
| **Owner** | `docs` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `docs/journal/YYMMDD-title.md` |
