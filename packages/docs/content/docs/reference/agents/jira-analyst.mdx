...
| | |
|---|---|
| **Source** | [`.claude/agents/jira-analyst.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/jira-analyst.md) |
| **Owner** | `jira` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `docs/project-context.md`, `tasks/reports/jira-analyze-{YYMMDD}-{HHMM}-{ISSUE-KEY}.md` |
