...
| | |
|---|---|
| **Source** | [`.claude/agents/shipper.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/shipper.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | high |
| **Writes** | `docs/project-context.md`, `tasks/reviews/YYMMDD-name-verdict.md` |
