...
| | |
|---|---|
| **Source** | [`.claude/agents/project-manager.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/project-manager.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `tasks/plans/*/`, `{plan-dir}/status-reports/*-status.md` |
