...
| | |
|---|---|
| **Source** | [`.claude/agents/jira-estimator.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/jira-estimator.md) |
| **Owner** | `jira` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `docs/project-context.md`, `tasks/reports/jira-estimate-*.md` |
