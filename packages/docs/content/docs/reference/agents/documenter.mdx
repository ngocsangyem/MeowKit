...
| | |
|---|---|
| **Source** | [`.claude/agents/documenter.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/documenter.md) |
| **Owner** | `docs` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `docs/`, `docs/architecture/`, `docs/journal/` |
