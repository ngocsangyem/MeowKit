...
| | |
|---|---|
| **Source** | [`.claude/agents/confluence-spec-analyst.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/confluence-spec-analyst.md) |
| **Owner** | `confluence` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `/`, `docs/project-context.md`, `research/`, `tasks/reports/` |
