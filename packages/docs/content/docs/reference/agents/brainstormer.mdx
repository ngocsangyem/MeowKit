...
| | |
|---|---|
| **Source** | [`.claude/agents/brainstormer.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/brainstormer.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `.claude/rules/security-rules.md`, `.meowkit/memory/architecture-decisions.json`, `docs/architecture/`, `docs/project-context.md` |
