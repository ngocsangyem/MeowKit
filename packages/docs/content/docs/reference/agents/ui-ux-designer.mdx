...
| | |
|---|---|
| **Source** | [`.claude/agents/ui-ux-designer.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/ui-ux-designer.md) |
| **Owner** | `docs` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `app/`, `docs/design-guidelines.md`, `docs/ui-specs/`, `docs/wireframe/`, `lib/`, `src/` |
