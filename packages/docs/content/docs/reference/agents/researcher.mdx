...
| | |
|---|---|
| **Source** | [`.claude/agents/researcher.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/researcher.md) |
| **Owner** | `research` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `.claude/rules/memory-read-rules.md`, `.claude/rules/security-rules.md`, `.meowkit/memory/architecture-decisions.json`, `.meowkit/memory/review-patterns.json`, `docs/project-context.md` |
