...
| | |
|---|---|
| **Source** | [`.claude/agents/jira-evaluator.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/jira-evaluator.md) |
| **Owner** | `jira` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Writes** | `.meowkit/.env`, `docs/project-context.md`, `tasks/reports/jira-evaluate-*.md` |
