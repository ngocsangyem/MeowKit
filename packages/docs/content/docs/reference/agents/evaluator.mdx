...
| | |
|---|---|
| **Source** | [`.claude/agents/evaluator.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/agents/evaluator.md) |
| **Owner** | `testing` |
| **Runtime** | `claude-code` |
| **Risk** | high |
| **Writes** | `tasks/reviews/`, `tasks/reviews/*-evalverdict-evidence/`, `tasks/reviews/*-evalverdict.md` |
