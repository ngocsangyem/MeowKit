...
| | |
|---|---|
| **Source** | [`.claude/skills/review/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/review/SKILL.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | high |
...
- **The skill writes patterns to `.meowkit/memory/review-patterns.md`** -- building institutional review knowledge over time
