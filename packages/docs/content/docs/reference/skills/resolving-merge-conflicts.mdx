...
| | |
|---|---|
| **Source** | [`.claude/skills/resolving-merge-conflicts/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/resolving-merge-conflicts/SKILL.md) |
| **Owner** | `git` |
| **Runtime** | `claude-code` |
| **Risk** | high |
