...
| | |
|---|---|
| **Source** | [`.claude/skills/scout/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/scout/SKILL.md) |
| **Owner** | `research` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
- **Read** `.meowkit/memory/codebase-map.md` before scouting if it exists — previous scouts can accelerate re-scouting
