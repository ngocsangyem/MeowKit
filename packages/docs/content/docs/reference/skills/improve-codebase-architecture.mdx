...
| | |
|---|---|
| **Source** | [`.claude/skills/improve-codebase-architecture/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/improve-codebase-architecture/SKILL.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Phase** | `on-demand` |
