...
| | |
|---|---|
| **Source** | [`.claude/skills/benchmark/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/benchmark/SKILL.md) |
| **Owner** | `testing` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
- **Persist baselines:** After each completed run, appends a cost baseline to `.meowkit/telemetry/cost-log.json` and emits a `benchmark_result` event to `.meowkit/telemetry/trace-log.jsonl`.
