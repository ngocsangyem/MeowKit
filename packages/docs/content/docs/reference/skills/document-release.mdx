...
| | |
|---|---|
| **Source** | [`.claude/skills/document-release/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/document-release/SKILL.md) |
| **Owner** | `docs` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
- **Reads memory:** `.meowkit/memory/architecture-decisions.md`, `.meowkit/memory/review-patterns.md`
