...
| | |
|---|---|
| **Source** | [`.claude/skills/autobuild/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/autobuild/SKILL.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | high |
