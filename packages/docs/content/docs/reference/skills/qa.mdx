...
| | |
|---|---|
| **Source** | [`.claude/skills/qa/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/qa/SKILL.md) |
| **Owner** | `testing` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
10. **Report** -- Write structured report to `.meowkit/memory/qa-reports/` with health score delta, fix status per issue, PR summary
...
- **Check `.meowkit/memory/qa-reports/`** for historical reports and baselines for regression comparisons
