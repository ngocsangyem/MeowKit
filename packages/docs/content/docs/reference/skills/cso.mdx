...
| | |
|---|---|
| **Source** | [`.claude/skills/cso/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/cso/SKILL.md) |
| **Owner** | `security` |
| **Runtime** | `claude-code` |
| **Risk** | high |
...
| 14 | Save Report | JSON schema to `.meowkit/memory/security-reports/` |
...
8. **Save** -- JSON report to `.meowkit/memory/security-reports/` (Phase 14)
