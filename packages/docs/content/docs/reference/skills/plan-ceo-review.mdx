...
| | |
|---|---|
| **Source** | [`.claude/skills/plan-ceo-review/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/plan-ceo-review/SKILL.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
- For EXPANSION/SELECTIVE modes, the CEO plan is persisted to `.meowkit/memory/projects/ceo-plans/` and can be promoted to `docs/designs/`
