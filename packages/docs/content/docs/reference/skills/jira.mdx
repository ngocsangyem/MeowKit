...
| | |
|---|---|
| **Source** | [`.claude/skills/jira/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/jira/SKILL.md) |
| **Owner** | `jira` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Phase** | `on-demand` |
...
Install, authentication, safety rules, and troubleshooting live on [Jira Integration](/guides/jira-integration). The variable list is in [Configuration](/reference/configuration#jira).
