...
| | |
|---|---|
| **Source** | [`.claude/skills/party/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/party/SKILL.md) |
| **Owner** | `research` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
- **Mandatory output:** decision written to `.meowkit/memory/decisions.md` in specified format
...
7. **Write** — persist decision to `.meowkit/memory/decisions.md`
...
- **Read the decision later.** `.meowkit/memory/decisions.md` persists across sessions so future tasks can reference past architecture choices.
