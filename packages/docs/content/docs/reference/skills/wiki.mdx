...
| | |
|---|---|
| **Source** | [`.claude/skills/wiki/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/wiki/SKILL.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `portable` |
| **Risk** | medium |
...
Captures long-term, provenance-bearing project knowledge through the gated `mewkit wiki` subsystem. Canonical pages live under `tasks/wikis/<slug>/`; a derived, rebuildable FTS index lives in `.meowkit/cache/wiki-index.db`.
