...
| | |
|---|---|
| **Source** | [`.claude/skills/lazy-agent-loader/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/lazy-agent-loader/SKILL.md) |
| **Owner** | `research` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
The skill maintains a compact index of every agent:
