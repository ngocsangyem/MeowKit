...
| | |
|---|---|
| **Source** | [`.claude/skills/evaluate/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/evaluate/SKILL.md) |
| **Owner** | `testing` |
| **Runtime** | `claude-code` |
| **Risk** | high |
...
After each completed evaluation, appends a summary line to `.meowkit/memory/review-patterns.md`:
