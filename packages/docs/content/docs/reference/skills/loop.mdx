...
| | |
|---|---|
| **Source** | [`.claude/skills/loop/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/loop/SKILL.md) |
| **Owner** | `memory` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
| **Phase** | `on-demand` |
...
> **Canonical source:** `.claude/skills/loop/SKILL.md`
