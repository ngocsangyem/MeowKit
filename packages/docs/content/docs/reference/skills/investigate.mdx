...
| | |
|---|---|
| **Source** | [`.claude/skills/investigate/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/investigate/SKILL.md) |
| **Owner** | `research` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
- **Memory integration:** Reads `.meowkit/memory/fixes.md` and `.meowkit/memory/architecture-decisions.md`; writes diagnosis records
...
- **The skill writes to `.meowkit/memory/fixes.md`** -- these diagnosis records build institutional knowledge over time
