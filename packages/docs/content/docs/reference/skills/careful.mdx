...
| | |
|---|---|
| **Source** | [`.claude/skills/careful/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/careful/SKILL.md) |
| **Owner** | `research` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
5. **Audit** — all overrides logged with timestamp and command to `.meowkit/telemetry/security-log.md`
