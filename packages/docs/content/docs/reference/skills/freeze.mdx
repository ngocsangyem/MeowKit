...
| | |
|---|---|
| **Source** | [`.claude/skills/freeze/SKILL.md`](https://github.com/ngocsangyem/MeowKit/blob/main/.claude/skills/freeze/SKILL.md) |
| **Owner** | `lifecycle` |
| **Runtime** | `claude-code` |
| **Risk** | medium |
...
3. **Path resolution:**
   ...
   ```
4. **State stored:** `${CLAUDE_PLUGIN_DATA:-.meowkit/memory}/freeze-dir.txt`
