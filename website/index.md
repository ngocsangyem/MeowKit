...
features:
  ...
  - title: 🗣️ Party Mode
    details: /mk:party for multi-agent deliberation. 2-4 agents debate architecture decisions with forced synthesis before any code is written.
  ...
  - title: 🧭 Navigation Help
    details: /mk:help scans plans, reviews, tests, and git to determine where you are in the pipeline and prints the single next action. Re-orient instantly after any interruption.
---
