...
| Personas | Reused from mk:review | Plan-specific (PHASE:SECTION) |
...
| File | Change |
|------|--------|
| `.claude/skills/plan-creator/SKILL.md` | Bumped to v1.4.0, updated step list |
| `.claude/skills/plan-creator/workflow.md` | 9-step sequence |
| `.claude/skills/plan-creator/workflow-fast.md` | NEW — compact fast path |
| `.claude/skills/plan-creator/step-04-semantic-checks.md` | Renamed from old step-04 (validation only) |
| `.claude/skills/plan-creator/step-05-red-team.md` | NEW — dedicated red-team step |
| `.claude/skills/plan-creator/step-06-validation-interview.md` | Split from old step-04 |
| `.claude/skills/plan-creator/step-07-gate.md` | Split from old step-04 |
| `.claude/skills/plan-creator/step-08-hydrate-tasks.md` | Renamed from old step-05 |
| `.claude/skills/plan-creator/prompts/personas/plan-assumption-destroyer.md` | NEW |
| `.claude/skills/plan-creator/prompts/personas/plan-scope-complexity-critic.md` | NEW |
| `.claude/skills/plan-creator/docs/parallel-mode.md` | NEW |
| `.claude/skills/plan-creator/docs/two-approach-mode.md` | NEW |
| `.claude/skills/plan-creator/docs/gotchas.md` | +6 gotchas |
| `.claude/rules/step-file-rules.md` | mk:plan-creator added to step-file enabled list |
