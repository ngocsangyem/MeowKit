      ...
      '/reference/': [
        {
          ...
          items: [
            ...
            { text: 'advisor', link: '/reference/agents/advisor' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'jira-issue', link: '/reference/agents/jira-issue' },
            { text: 'jira-search', link: '/reference/agents/jira-search' },
            { text: 'jira-lifecycle', link: '/reference/agents/jira-lifecycle' },
            { text: 'jira-collaborate', link: '/reference/agents/jira-collaborate' },
            { text: 'jira-relationships', link: '/reference/agents/jira-relationships' },
            { text: 'jira-time', link: '/reference/agents/jira-time' },
            { text: 'jira-agile', link: '/reference/agents/jira-agile' },
            { text: 'jira-fields', link: '/reference/agents/jira-fields' },
            { text: 'jira-bulk', link: '/reference/agents/jira-bulk' },
            { text: 'jira-jsm', link: '/reference/agents/jira-jsm' },
            { text: 'jira-admin', link: '/reference/agents/jira-admin' },
            { text: 'jira-dev', link: '/reference/agents/jira-dev' },
            { text: 'jira-ops', link: '/reference/agents/jira-ops' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'mk:advise', link: '/reference/skills/advise' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'mk:research', link: '/reference/skills/research' },
        ...
        {
          text: 'Jira (Router + Family)',
          collapsed: true,
          items: [
            { text: 'mk:jira (router)', link: '/reference/skills/jira' },
            { text: 'mk:jira-issue', link: '/reference/skills/jira-issue' },
            { text: 'mk:jira-search', link: '/reference/skills/jira-search' },
            { text: 'mk:jira-lifecycle', link: '/reference/skills/jira-lifecycle' },
            { text: 'mk:jira-collaborate', link: '/reference/skills/jira-collaborate' },
            { text: 'mk:jira-relationships', link: '/reference/skills/jira-relationships' },
            { text: 'mk:jira-time', link: '/reference/skills/jira-time' },
            { text: 'mk:jira-agile', link: '/reference/skills/jira-agile' },
            { text: 'mk:jira-fields', link: '/reference/skills/jira-fields' },
            { text: 'mk:jira-bulk', link: '/reference/skills/jira-bulk' },
            { text: 'mk:jira-jsm', link: '/reference/skills/jira-jsm' },
            { text: 'mk:jira-admin', link: '/reference/skills/jira-admin' },
            { text: 'mk:jira-dev', link: '/reference/skills/jira-dev' },
            { text: 'mk:jira-ops', link: '/reference/skills/jira-ops' },
      ...
      '/workflows/': [
        {
          ...
          items: [
            ...
            { text: 'Agile / Scrum Workflow', link: '/workflows/agile-scrum' },
            ...
            { text: 'Spec → PR: Behind the Scenes', link: '/workflows/spec-to-pr-walkthrough' },
          ],
        },
      ],
    },
